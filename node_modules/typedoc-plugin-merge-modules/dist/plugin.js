...
class Plugin {
    ...
    subscribeToApplicationEvents(typedoc) {
        typedoc.on(typedoc_1.Application.EVENT_BOOTSTRAP_END, (c) => this.onApplicationBootstrapEnd(c));
        ...
        const typeDocUsesMultipleConverters = typedoc.entryPointStrategy === typedoc_1.EntryPointStrategy.Merge ||
            typedoc.entryPointStrategy === typedoc_1.EntryPointStrategy.Packages;
        if (typeDocUsesMultipleConverters) {
            typedoc.on(typedoc_1.Application.EVENT_PROJECT_REVIVE, (c) => this.onConvertersDone(c));
        }
        else {
            typedoc.converter.on(typedoc_1.Converter.EVENT_RESOLVE_BEGIN, (c) => this.onConvertersDone(c));
        }
    }
    /**
     ...
     */
    onApplicationBootstrapEnd(context) {
