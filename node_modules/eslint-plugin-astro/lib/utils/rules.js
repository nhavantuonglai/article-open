...
const missing_client_only_directive_value_1 = __importDefault(require("../rules/missing-client-only-directive-value"));
...
const no_deprecated_getentrybyslug_1 = __importDefault(require("../rules/no-deprecated-getentrybyslug"));
...
exports.rules = [
    missing_client_only_directive_value_1.default,
    ...
    no_deprecated_getentrybyslug_1.default,
