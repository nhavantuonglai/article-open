...
The idea behind this approach is that the higher weights will _occupy_ more numeric space. Therefore, there is a higher chance that the random number will fall into the _higher weight numeric bucket._
