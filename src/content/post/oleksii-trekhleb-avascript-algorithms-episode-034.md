...
- The raw equations for the Fourier Transform just say _add the complex numbers_. Many programming languages cannot handle complex numbers directly, so you convert everything to rectangular coordinates and add those.
