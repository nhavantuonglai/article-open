...
You may also find more test-case examples of how the LRU Cache works in [LRUCache.test.js](https://upload.wikimedia.org/__test__/LRUCache.test.js) file.
...
You may also find more test-case examples of how the LRU Cache works in [LRUCacheOnMap.test.js](https://upload.wikimedia.org/__test__/LRUCacheOnMap.test.js) file.
