...
title: Kyle Simpson | You dont know Javascript (Episode 9)
...
| NOTE: |
| : –   - |
| Node also exposes several elements "globally," but they're technically not in the `global` scope: `require()`, `_dirname`, `module`, `URL`, and so on. |
...
```js
function Module(module,require,_dirname,…) {
var studentName = "Kyle";
