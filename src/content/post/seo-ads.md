...
Ví dụ về kết quả của Google Search thể hiện kết quả nhiều định dạng cho cửa hàng thực tế.
...
Công cụ quản trị web Bing (Bing Webmaster Tools) của Microsoft cũng cung cấp nhiều công cụ cho chủ sở hữu website.
