...
![Update workflow in a multi-page application](https://data.nhavantuonglai.com/image/mpa.png)
...
![Update workflow in a single-page application](https://data.nhavantuonglai.com/image/spa.png)
...
![Screenshot showing the error message displayed during login](https://data.nhavantuonglai.com/image/login-error.png)
...
![Screenshot of an example result of the dashboard after styling](https://data.nhavantuonglai.com/image/screen2.png)
