...
![Browser sketchnote](https://data.nhavantuonglai.com/image/browser.jpg)
...
![early browsers](https://data.nhavantuonglai.com/image/earlybrowsers.jpg)
...
![screenshot of the Edge browser showing the open edge://extensions page and open settings menu](https://data.nhavantuonglai.com/image/install-on-edge.png)
...
![screenshot of the completed extension open in a browser, displaying a form with inputs for region name and API key.](https://data.nhavantuonglai.com/image/1.png)

And the second to display the region's carbon usage:

![screenshot of the completed extension displaying values for carbon usage and fossil fuel percentage for the US-NEISO region.](https://data.nhavantuonglai.com/image/2.png)
