...
Vào thời điểm nào đó tối qua, có người đã kết nối vào hệ thống của chúng tôi và tìm cách tiếp cận máy Unix – 4 một cách bài bản. Trước tiên, hắn thử đăng nhập vào tài khoản Guest [khách] với mật khẩu _Guest._ Sau đó, hắn thử tên tài khoản Visitor [khách], với mật khẩu là _Visitor_; rồi đến các tên tài khoản Root [rễ], System [hệ thống], Manager [quản lý], và Sysop [điều hành hệ thống]. Sau một vài phút, kẻ tấn công bỏ đi.
