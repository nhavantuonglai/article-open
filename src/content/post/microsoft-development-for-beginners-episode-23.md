...
![Schema showing the data flows between the HTML, user actions and state](https://data.nhavantuonglai.com/image/data-flow.png)
...
![Screenshot showing an example "Add transaction" dialog](https://data.nhavantuonglai.com/image/dialog.png)
