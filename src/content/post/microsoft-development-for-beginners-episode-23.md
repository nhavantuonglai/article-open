...
title: Microsoft | Development for beginners (Episode 13)
...
You need to have completed the data fetching part of the web app for this lesson. You also need to install [Node.js](https://nodejs.org) and run the server API locally so you can manage account data.
...
We'll now take the chance to fix the issue of account data not being cleared when the user clicks on _Logout._
