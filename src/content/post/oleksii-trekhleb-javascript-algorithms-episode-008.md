...
This method is a combination of _Clear Bit_ and _Set Bit_ methods.
...
To do so it uses _Twos Complement_ approach which does it by
...
This method is based on that _Every number can be denoted as the sum of powers of 2._
...
with and without a _carry bit_ from adding the previous less-significant stage.
