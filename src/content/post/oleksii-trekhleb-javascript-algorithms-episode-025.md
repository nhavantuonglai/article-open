...
title: Oleksii Trekhleb | Javascript algorithms (Euclidean algorithm)
...
multiples of a common _unit_ length. The length `DC` being
shorter, it is used to _measure_ `BA`, but only once because
