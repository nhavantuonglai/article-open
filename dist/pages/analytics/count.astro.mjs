...
import 'clsx';
import { $ as $$Count$2 } from '../../chunks/count_CZkYR-pS.mjs';
...
const $$Count = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Page, { "metadata": metadata }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Count", $$Count$1, {})} ${renderComponent($$result2, "Content", $$Count$2, {})} ${renderComponent($$result2, "Action", $$Action, {})} ${renderComponent($$result2, "Soundcloud", $$Soundcloud, {})} ` })}`;
