...
import 'clsx';
import { $ as $$Compare$2 } from '../../chunks/compare_XQntvuqE.mjs';
...
const $$Compare = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Page, { "metadata": metadata }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Compare", $$Compare$1, {})} ${renderComponent($$result2, "Content", $$Compare$2, {})} ${renderComponent($$result2, "Action", $$Action, {})} ${renderComponent($$result2, "Flowschart", $$Flowschart, {})} ` })}`;
