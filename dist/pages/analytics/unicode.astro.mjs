...
var _a;
const $$Unicode$2 = createComponent(($$result, $$props, $$slots) => {
...
const $$Unicode$1 = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="relative md:-mt-[76px] not-prose"> <div class="absolute inset-0 pointer-events-none" aria-hidden="true"></div> <div class="relative max-w-7xl mx-auto"> <div class="pt-0 md:pt-[120px] pointer-events-none"></div> ${renderComponent($$result, "CTA", $$Services, { "callToAction": {
    ...
    {
      title: "Highlight c\xE1c ti\xEAu \u0111\u1EC1",
      description: "Gi\xFAp t\xF9y bi\u1EBFn v\u0103n b\u1EA3n th\xF4 th\xE0nh c\xE1c ki\u1EC3u ch\u1EEF m\u1EDBi, \u0111\u1ED9c \u0111\xE1p v\xE0 \u0111\u1EB9p m\u1EAFt \u0111\u1EC3 t\u1EA1o highlight, t\u0103ng n\u1ED5i b\u1EADt cho b\xE0i vi\u1EBFt Facebook c\u0169ng nh\u01B0 c\xE1c m\u1EA1ng x\xE3 h\u1ED9i kh\xE1c.",
      icon: "tabler:bell-school"
    },
    {
      title: "Chu\u1EA9n h\xF3a v\u0103n b\u1EA3n",
      description: "Gi\xFAp chu\u1EA9n h\xF3a d\u1EEF li\u1EC7u, chuy\u1EC3n v\u0103n b\u1EA3n Unicode th\xE0nh v\u0103n b\u1EA3n th\xF4, giao ti\u1EBFp hi\u1EC7u qu\u1EA3 v\xE0 ch\xEDnh x\xE1c gi\u1EEFa ng\u01B0\u1EDDi d\xF9ng v\xE0 c\xE1c h\u1EC7 th\u1ED1ng, n\u1EC1n t\u1EA3ng h\u01A1n.",
      icon: "tabler:brand-codecov"
    }
  ], "image": {
    src: "https://nhavantuonglai.com/image/cover/001-351.jpg",
...
Công cụ chuyển đổi văn bản Unicode giúp tối ưu và chuẩn hóa dữ liệu phục vụ các chiến dịch nghiên cứu, marketing.
` })}` })} </div> </section> ${renderComponent($$result, "Question", $$Question, { "items": [
    {
      title: "S\u1EED d\u1EE5ng c\xF4ng c\u1EE5 nh\u01B0 th\u1EBF n\xE0o?",
      description: "\u0110\u1EC3 s\u1EED d\u1EE5ng c\xF4ng c\u1EE5 chuy\u1EC3n \u0111\u1ED5i v\u0103n b\u1EA3n Unicode, b\u1EA1n ch\u1EC9 c\u1EA7n d\xE1n v\u0103n b\u1EA3n v\xE0o v\xE0 nh\u1EA5n Chuy\u1EC3n \u0111\u1ED5i, k\u1EBFt qu\u1EA3 s\u1EBD hi\u1EC7n ngay l\u1EADp t\u1EE9c..",
      icon: "tabler:chevrons-right"
    },
    {
      title: "C\xF3 gi\u1EDBi h\u1EA1n khi s\u1EED d\u1EE5ng c\xF4ng c\u1EE5 kh\xF4ng?",
      description: `C\xF4ng c\u1EE5 chuy\u1EC3n \u0111\u1ED5i v\u0103n b\u1EA3n Unicode kh\xF4ng gi\u1EDBi h\u1EA1n s\u1ED1 l\u1EA7n s\u1EED d\u1EE5ng, nh\u01B0ng d\u1EEF li\u1EC7u qu\xE1 l\u1EDBn c\xF3 th\u1EC3 \u1EA3nh h\u01B0\u1EDFng \u0111\u1EBFn t\u1ED1c \u0111\u1ED9 x\u1EED l\xFD.`,
      icon: "tabler:chevrons-right"
    },
    {
      title: "Nh\u1EEFng gi\u1EA3i ph\xE1p thay th\u1EBF kh\xE1c ph\xF9 h\u1EE3p \u0111\u1EC3 gi\u1EA3i quy\u1EBFt y\xEAu c\u1EA7u chuy\u1EC3n \u0111\u1ED5i v\u0103n b\u1EA3n Unicode",
...
}, "D:/Onecode/article-open/src/components/javascript/unicode.astro", void 0);
...
const $$Unicode = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Unicode", $$Unicode$2, {})} ${renderComponent($$result2, "Content", $$Unicode$1, {})} ` })}`;
