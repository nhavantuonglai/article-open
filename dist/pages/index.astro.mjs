import { b as createAstro, c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead, u as unescapeHTML, e as addAttribute, F as Fragment } from '../chunks/astro/server_D74Uuew0.mjs';
import 'kleur/colors';
import { b as $$Icon, a as $$Button, $ as $$Page } from '../chunks/page_D0LVH7FG.mjs';
import { $ as $$Hero } from '../chunks/hero_M2Y8KcXb.mjs';
import { $ as $$Grid } from '../chunks/grid_C28bnv9r.mjs';
import { a as getBlogPermalink } from '../chunks/consts_DfSyGgUe.mjs';
import { d as findLatestPosts } from '../chunks/blog_BED9qZzI.mjs';
import { c as Slideright, d as $$Wrapper, e as $$Headline, f as Slideleft, b as $$Image, a as $$Action } from '../chunks/action_dcaZU4o7.mjs';
import { $ as $$Copywriter } from '../chunks/copywriter_E3shS97g.mjs';
import { $ as $$Website } from '../chunks/website_MOl9jUHN.mjs';
import { $ as $$Seo } from '../chunks/seo_iQMedcZn.mjs';
import { $ as $$Marketing } from '../chunks/marketing_CVVvoP55.mjs';
import { a as $$Block, $ as $$Prices } from '../chunks/prices_BNc9qOHy.mjs';
...
const $$Latest = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Slideright", Slideright, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "~/assets/framer.jsx", "client:component-export": "Slideright" }, { "default": ($$result2) => renderTemplate`${renderTemplate`${renderComponent($$result2, "Wrapper", $$Wrapper, { "id": id, "isDark": isDark, "containerClass": classes?.container, "bg": bg }, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="flex flex-col lg:justify-between lg:flex-row"> ${title && renderTemplate`<div class="md:max-w-sm"> <h2 class="max-w-3xl mx-auto">${unescapeHTML(title)}</h2> </div>`} ${information && renderTemplate`<p class="text-xl text-justify max-w-md">${unescapeHTML(information)}</p>`} </div> ${renderComponent($$result3, "Grid", $$Grid, { "posts": posts })} <a class="btn hover:text-primary" href="https://nhavantuonglai.com/article">
Đọc thêm
</a> ` })}`}` })}`;
}, "D:/OneCode/article-open/src/components/article/latest.astro", void 0);

const $$Article = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Article", $$Latest, { "title": "B\xE0i vi\u1EBFt g\u1EA7n \u0111\xE2y", "information": `Bao g\u1ED3m 12 b\xE0i m\u1EDBi xu\u1EA5t b\u1EA3n g\u1EA7n \u0111\xE2y, ch\u1EE9a nhi\u1EC1u n\u1ED9i dung m\u1EDBi m\u1EBB v\xE0 h\u1EA5p d\u1EABn, th\xFA v\u1ECB \u0111\u1EE3i b\u1EA1n kh\xE1m ph\xE1.` })}`;
...
const $$Brands$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Slideright", Slideright, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "~/assets/framer.jsx", "client:component-export": "Slideright" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Block", $$Block, { "id": id, "isDark": isDark, "containerClass": `max-w-6xl mx-auto ${classes?.container ?? ""}`, "bg": bg }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Headline", $$Headline, { "title": title, "subtitle": subtitle, "tagline": tagline, "class": "leading-tighter text-4xl md:text-5xl font-bold leading-tighter tracking-tighter mb-6 font-heading" })} ${maybeRenderHead()}<div class="flex flex-wrap justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24 overflow-hidden px-4 md:px-6"> ${icons && icons.map((icon) => renderTemplate`${renderComponent($$result3, "Icon", $$Icon, { "name": icon, "class": "py-3 lg:py-5 w-12 h-auto mx-auto sm:mx-0 text-gray-500" })}`)} ${images && images.map(
...
const $$Brands = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Brands", $$Brands$1, { "title": "Tin t\u01B0\u1EDFng b\u1EDFi kh\xE1ch h\xE0ng c\u1EE7a", "images": [
    {
      src: "https://banmaixanh.org/image/clients/facebook.png",
      alt: "Facebook"
    },
    {
      src: "https://banmaixanh.org/image/clients/google.png",
      alt: "Google"
    },
    {
      src: "https://banmaixanh.org/image/clients/microsoft.png",
      alt: "Microsoft"
    },
    {
      src: "https://banmaixanh.org/image/clients/netflix.png",
      alt: "Netflix"
    },
    {
      src: "https://banmaixanh.org/image/clients/spotify.png",
      alt: "Spotify"
    },
    {
      src: "https://banmaixanh.org/image/clients/tiktok.png",
      alt: "Tiktok"
    },
    {
      src: "https://banmaixanh.org/image/clients/apple.png",
      alt: "Apple"
    }
  ] })}`;
...
const $$Testimonials$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Slideleft", Slideleft, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "~/assets/framer.jsx", "client:component-export": "Slideleft" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Block", $$Block, { "id": id, "isDark": isDark, "containerClass": `max-w-6xl mx-auto ${classes?.container ?? ""}`, "bg": bg }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Headline", $$Headline, { "title": title, "subtitle": subtitle, "tagline": tagline })} ${maybeRenderHead()}<div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6"> ${testimonials && testimonials.length > 0 && testimonials.map(({ title: title2, testimonial, name, job, image }) => renderTemplate`<div class="flex h-auto"> <div class="text-justify flex flex-col p-4 md:p-6 rounded-md shadow-xl dark:shadow-none dark:border dark:border-slate-600"> ${testimonial && renderTemplate`<blockquote class="flex-auto"> <p class="text-xl italic">${testimonial}</p> </blockquote>`} <hr class="border-slate-200 dark:border-slate-600 my-4"> <div class="flex"> ${image && renderTemplate`<div class="h-10 w-10 rounded-full border border-slate-200 dark:border-slate-600"> ${typeof image === "string" ? renderTemplate`${renderComponent($$result3, "Fragment", Fragment, {}, { "default": ($$result4) => renderTemplate`${unescapeHTML(image)}` })}` : renderTemplate`${renderComponent($$result3, "Image", $$Image, { "class": "h-10 w-10 rounded-full border border-slate-200 dark:border-slate-600 min-w-full min-h-full", "width": 40, "height": 40, "layout": "fixed", ...image })}`} </div>`} <div${addAttribute(title2, "title")} class="grow ml-3 rtl:ml-0 rtl:mr-3"> ${name && renderTemplate`<p class="text-xl font-bold">${name}</p>`} ${job && renderTemplate`<p class="text-sm text-muted">${job}</p>`} </div> </div> </div> </div>`)} </div> ${callToAction && renderTemplate`<div class="flex justify-center mx-auto w-fit mt-8 md:mt-62 font-medium"> ${renderComponent($$result3, "Button", $$Button, { ...callToAction })} </div>`}` })} ` })}`;
  ...
  return renderTemplate`${renderComponent($$result, "Testimonials", $$Testimonials$1, { "title": "\u0110\xE1nh gi\xE1 t\u1EEB kh\xE1ch h\xE0ng", "testimonials": [
    {
      ...
      image: {
        src: "https://banmaixanh.org/image/member/nguyen-dan-nguyen.jpg",
    ...
    },
    {
      ...
      image: {
        src: "https://banmaixanh.org/image/member/tran-my-anh.jpg",
    ...
    },
    {
      ...
      image: {
        src: "https://banmaixanh.org/image/member/le-my-kim.jpg",
...
const $$Asked = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "FAQ", $$Question, { "title": "10 v\u1EA1n c\xE2u h\u1ECFi t\xE0o lao", "items": [
    {
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Page, { "metadata": metadata }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$Hero, {})} ${renderComponent($$result2, "Article", $$Article, {})} ${renderComponent($$result2, "Copywriter", $$Copywriter, {})} ${renderComponent($$result2, "Website", $$Website, {})} ${renderComponent($$result2, "SEO", $$Seo, {})} ${renderComponent($$result2, "Marketing", $$Marketing, {})} ${renderComponent($$result2, "Prices", $$Prices, {})} ${renderComponent($$result2, "Brands", $$Brands, {})} ${renderComponent($$result2, "Testimonials", $$Testimonials, {})} ${renderComponent($$result2, "Aks", $$Asked, {})} ${renderComponent($$result2, "Action", $$Action, {})} ` })}`;
