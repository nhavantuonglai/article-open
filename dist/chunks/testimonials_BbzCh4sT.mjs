import { c as createComponent, r as renderTemplate, a as renderComponent, F as Fragment, m as maybeRenderHead, d as createAstro, b as addAttribute, u as unescapeHTML } from './astro/server_CPaUVu3N.mjs';
import 'kleur/colors';
import { $ as $$Services$1, a as $$WidgetWrapper, b as $$Headline } from './services_BOpoSTm3.mjs';
...
const $$Services = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Services", $$Services$1, { "title": "D\u1ECBch v\u1EE5 cung c\u1EA5p", "items": [
    ...
    src: "https://nhavantuonglai.com/image/cover/001-524.jpg",
...
` })}` })} ${renderComponent($$result, "Services", $$Services$1, { "isReversed": true, "isAfterContent": true, "items": [
    ...
    src: "https://nhavantuonglai.com/image/cover/001-513.jpg",
...
` })}` })} ${renderComponent($$result, "Services", $$Services$1, { "isAfterContent": true, "items": [
    ...
    src: "https://nhavantuonglai.com/image/cover/001-499.jpg",
...
export { $$Services as $, $$Brands as a, $$Testimonials as b };
