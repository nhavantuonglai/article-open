...
const $$Compare = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="relative md:-mt-[76px] not-prose"> <div class="absolute inset-0 pointer-events-none" aria-hidden="true"></div> <div class="relative max-w-7xl mx-auto"> <div class="pt-0 md:pt-[120px] pointer-events-none"></div> ${renderComponent($$result, "CTA", $$Services, { "callToAction": {
    ...
    {
      title: "L\u1ECDc d\u1EEF li\u1EC7u th\u1EEBa, t\xECm d\u1EEF li\u1EC7u thi\u1EBFu",
      description: "D\u1EF1a v\xE0o kh\u1EA3 n\u0103ng th\u1ED1ng k\xEA v\xE0 ph\xE2n lo\u1EA1i, h\u1EC7 th\u1ED1ng s\u1EBD cung c\u1EA5p c\xE1c d\u1EEF li\u1EC7u b\u1ECB th\u1EEBa, thi\u1EBFu trong m\u1ED7i n\u1ED9i dung.",
...
Công cụ đối chiếu văn bản giúp thống kê, lọc dữ liệu thừa và tìm dữ liệu thiếu trong 2 nội dung, văn bản, giúp bạn đơn giản hóa nhiều tác vụ hơn.
` })}` })} </div> </section> ${renderComponent($$result, "Question", $$Question, { "items": [
    {
      title: "S\u1EED d\u1EE5ng c\xF4ng c\u1EE5 nh\u01B0 th\u1EBF n\xE0o?",
      description: "\u0110\u1EC3 s\u1EED d\u1EE5ng c\xF4ng c\u1EE5 \u0111\u1ED1i chi\u1EBFu v\u0103n b\u1EA3n, ch\u1EC9 c\u1EA7n d\xE1n d\u1EEF li\u1EC7u v\xE0 nh\u1EA5n Chuy\u1EC3n \u0111\u1ED5i, k\u1EBFt qu\u1EA3 s\u1EBD hi\u1EC3n th\u1ECB t\u1EE9c th\xEC.",
      icon: "tabler:chevrons-right"
    },
    {
      title: "C\xF3 gi\u1EDBi h\u1EA1n khi s\u1EED d\u1EE5ng c\xF4ng c\u1EE5 kh\xF4ng?",
      description: `C\xF4ng c\u1EE5 \u0111\u1ED1i chi\u1EBFu v\u0103n b\u1EA3n kh\xF4ng gi\u1EDBi h\u1EA1n s\u1ED1 l\u1EA7n s\u1EED d\u1EE5ng, nh\u01B0ng n\u1EBFu l\u01B0\u1EE3ng d\u1EEF li\u1EC7u qu\xE1 l\u1EDBn, qu\xE1 tr\xECnh ph\xE2n t\xEDch c\xF3 th\u1EC3 ch\u1EADm l\u1EA1i.`,
      icon: "tabler:chevrons-right"
    },
    {
...
}, "D:/OneCode/article-open/src/components/content/compare.astro", void 0);
