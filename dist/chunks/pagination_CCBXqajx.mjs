import { d as createAstro, c as createComponent, r as renderTemplate, m as maybeRenderHead, u as unescapeHTML, b as addAttribute, a as renderComponent, F as Fragment } from './astro/server_BfxwJWhM.mjs';
import 'kleur/colors';
import 'clsx';
import { f as findImage, a as $$Icon, b as $$Button } from './page-layout_7BvdpGlP.mjs';
import { $ as $$Image } from './image_Bsu-3NOb.mjs';
import { $ as $$Tags } from './tags_B4OAKphF.mjs';
import { a as getPermalink, b as getFormattedDate } from './permalinks_DgxcdhcO.mjs';
...
const $$Headline = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header class="mb-6 md:mb-12 text-center max-w-3xl mx-auto"> <h1 class="text-4xl md:text-5xl font-bold leading-tighter tracking-tighter font-heading">${unescapeHTML(title)}</h1> ${subtitle && renderTemplate`<div class="mt-2 md:mt-3 mx-auto text-xl text-gray-500 dark:text-slate-400 font-medium">${unescapeHTML(subtitle)}</div>`} </header>`;
}, "D:/Onecode/article-open/src/components/blog/headline.astro", void 0);
...
}, "D:/Onecode/article-open/src/components/blog/list-item.astro", void 0);
...
}, "D:/Onecode/article-open/src/components/blog/list.astro", void 0);
...
}, "D:/Onecode/article-open/src/components/blog/pagination.astro", void 0);
