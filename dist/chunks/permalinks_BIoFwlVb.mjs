...
const SITE = {"name":"nhavantuonglai","site":"https://nhavantuonglai.com","base":"/","trailingSlash":false,"googleSiteVerificationId":""};
										...
										const METADATA = {"title":{"default":"nhavantuonglai","template":"%s | nhavantuonglai"},"description":"nhavantuonglai là website cá nhân, chia sẻ góc nhìn qua viết lách, hình ảnh, đoản văn và nghiên cứu, phản ánh kỹ năng và hiểu biết xã hội.","robots":{"index":true,"follow":true},"openGraph":{"type":"website","site_name":"nhavantuonglai","image":{"url":"https://nhavantuonglai.com/image/cover/001-753.jpg","width":600,"height":407}},"twitter":{"handle":"@nhavantuonglai","site":"@nhavantuonglai","card":"summary_large_image","image":{"url":"https://nhavantuonglai.com/image/cover/001-746.jpg"},"title":"Đọc nhiều, hiểu sâu, viết hay cùng nhavantuonglai.","description":"nhavantuonglai là thương hiệu cá nhân, thông qua viết lách để chia sẻ góc nhìn, hiểu biết về những mối quan tâm, niềm đam mê và mục tiêu sống của bản thân."}};
										const APP_BLOG = {"isEnabled":true,"postsPerPage":20,"isRelatedPostsEnabled":true,"relatedPostsCount":12,"post":{"isEnabled":true,"permalink":"article/%slug%","robots":{"index":true,"follow":true}},"list":{"isEnabled":true,"pathname":"article","robots":{"index":true,"follow":true}},"category":{"isEnabled":true,"pathname":"category","robots":{"index":true,"follow":true}},"tag":{"isEnabled":true,"pathname":"tags","robots":{"index":true,"follow":true}}};
...
export { APP_BLOG as A, BLOG_BASE as B, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, getPermalink as a, getFormattedDate as b, getBlogPermalink as c, getCanonical as d, cleanSlug as e, getAsset as f, getHomePermalink as g, trimSlash as t };
